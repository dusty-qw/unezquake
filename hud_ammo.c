...
void Ammo_HudInit(void)
{
	...
	HUD_Register(
		...
		"1", "health", "after", "center", "32", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"align", "right",
		"digits", "3",
	...
	HUD_Register("ammo2", NULL, "Part of your inventory - ammo - nails.",
				 ...
				 "0", "ammo1", "after", "top", "0", "0", "0", "0 0 0", "0", NULL,
				 "style", "0",
				 "scale", "1",
				 "align", "right",
				 "digits", "3",
	...
	HUD_Register("ammo3", NULL, "Part of your inventory - ammo - rockets.",
				 ...
				 "0", "ammo2", "after", "top", "0", "0", "0", "0 0 0", "0", NULL,
				 "style", "0",
				 "scale", "1",
				 "align", "right",
				 "digits", "3",
	...
	HUD_Register("ammo4", NULL, "Part of your inventory - ammo - cells.",
				 ...
				 "0", "ammo3", "after", "top", "0", "0", "0", "0 0 0", "0", NULL,
				 "style", "0",
				 "scale", "1",
				 "align", "right",
				 "digits", "3",
	...
	HUD_Register(
		...
		"1", "ammo", "before", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"show_always", "0",
		NULL
