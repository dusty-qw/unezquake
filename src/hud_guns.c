...
void Guns_HudInit(void)
{
	...
	HUD_Register("gun", NULL, "Part of your inventory - current weapon.",
		...
		"0", "ibar", "center", "bottom", "0", "0", "0", "0 0 0", "0", NULL,
		"wide", "0",
		"style", "0",
		"scale", "1",
		"proportional", "0",
	...
	HUD_Register("gun2", NULL, "Part of your inventory - shotgun.",
		...
		"1", "ibar", "left", "bottom", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun3", NULL, "Part of your inventory - super shotgun.",
		...
		"1", "gun2", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun4", NULL, "Part of your inventory - nailgun.",
		...
		"1", "gun3", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun5", NULL, "Part of your inventory - super nailgun.",
		...
		"1", "gun4", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun6", NULL, "Part of your inventory - grenade launcher.",
		...
		"1", "gun5", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun7", NULL, "Part of your inventory - rocket launcher.",
		...
		"1", "gun6", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"style", "0",
		"scale", "1",
		"proportional", "0",
		NULL);
	HUD_Register("gun8", NULL, "Part of your inventory - thunderbolt.",
		...
		"1", "gun7", "after", "center", "0", "0", "0", "0 0 0", "0", NULL,
		"wide", "0",
		"style", "0",
		"scale", "1",
		"proportional", "0",
