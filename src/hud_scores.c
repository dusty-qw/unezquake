...
void Scores_HudInit(void)
{
	...
	HUD_Register(
		...
		"0", "screen", "left", "bottom", "0", "0", "0.5", "4 8 32", "0", "0 0 0", NULL,
		"style", "0",
		"scale", "1",
		"align", "right",
		"digits", "0",
	...
	HUD_Register(
		...
		"0", "score_team", "after", "bottom", "0", "0", "0.5", "32 4 0", "0", "0 0 0", NULL,
		"style", "0",
		"scale", "1",
		"align", "right",
		"digits", "0",
	...
	HUD_Register(
		...
		"0", "score_enemy", "after", "bottom", "0", "0", "0.5", "0 0 0", "0", "0 0 0", NULL,
		"style", "0",
		"scale", "1",
		"align", "right",
		"digits", "0",
	...
	HUD_Register("score_position", NULL, "Position on scoreboard.",
		...
		"0", "score_difference", "after", "bottom", "0", "0", "0.5", "0 0 0", "0", "0 0 0", NULL,
		"style", "0",
		"scale", "1",
		"align", "right",
		"digits", "0",
	...
	HUD_Register(
		...
		"0", "screen", "center", "console", "0", "0", "0.5", "0 0 0", "0", "0 0 0", NULL,
		"style", "0",
		"scale", "1",
	...
	HUD_Register(
		...
		"1", "screen", "center", "top", "0", "50", "0.2", "0 0 100", "0", "0 0 0", NULL,
		/*
		"color", "255 255 255",
		*/
		"timeout", "3",
