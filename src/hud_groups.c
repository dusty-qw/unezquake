...
void Groups_HudInit(void)
{
	...
	HUD_Register(
		...
		"0", "screen", "left", "top", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group1",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "center", "top", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group2",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "right", "top", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group3",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "left", "center", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group4",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "center", "center", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group5",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "right", "center", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group6",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "left", "bottom", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group7",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "center", "bottom", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group8",
		"width", "64",
		"height", "64",
		"picture", "",
	...
	HUD_Register(
		...
		HUD_NO_GROW, ca_disconnected, 0, SCR_HUD_Groups_Draw,
		"0", "screen", "right", "bottom", "0", "0", ".5", "0 0 0", "0", "0 0 0", NULL,
		"name", "group9",
		"width", "64",
		"height", "64",
		"picture", "",
